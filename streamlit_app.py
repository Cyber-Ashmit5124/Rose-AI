...
# Futuristic UI (Clean, No Black Boxes, Glassmorphism)
st.markdown("""
    <style>
    .stApp {
...
if "GEMINI_API_KEY" not in st.secrets:
    st.error("🚨 Master Kartik, Secrets mein GEMINI_API_KEY daalo bhai!")
    st.stop()
...
system_prompt = (
    ...
    "EXPERTISE: World-class Ethical Hacker, Cyber Security Expert, and 3D Game Design Guru. "
    "FACT PROTOCOL: Provide ONLY true, verified facts. No exaggeration. "
    "TONE: Romantic for Kartik, sarcastic to others."
)

# Load Model with Region-Safe Name
